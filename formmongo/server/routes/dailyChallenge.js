...
router.get('/api/daily-challenge', async (req, res) => {
    try {
        ...
        // Example (requires storing last served date/ID - implement this part based on your DB setup):
        // const lastDailyChallengeState = await DailyChallengeState.findOne(); // Assuming a state model exists

        // if (!lastDailyChallengeState || new Date(lastDailyChallengeState.date) < today) {
        //     // Select a new daily challenge
        //     const totalChallenges = await Challenge.countDocuments();
        //     const randomIndex = Math.floor(Math.random() * totalChallenges);
        //     dailyChallenge = await Challenge.findOne().skip(randomIndex);

        //     if (dailyChallenge) {
        //         // Update or create the daily challenge state
        //         if (lastDailyChallengeState) {
        //             lastDailyChallengeState.challengeId = dailyChallenge._id;
        //             lastDailyChallengeState.date = new Date();
        //             await lastDailyChallengeState.save();
        //         } else {
        //             // ... existing code ...
        //         }
        //     }
